...
const PredictionResult = ({ result, error }) => {
    ...
    if (
        ...
        !Array.isArray(result.allPredictions)
    ) {
        return null; // Tidak render jika data belum siap
    }
            ...
            <div className="space-y-6">
                ...
                <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className={`text-sm font-bold px-3 py-1 rounded-full ${result.probability >= 0.7 ? 'bg-green-100 text-green-700' :
